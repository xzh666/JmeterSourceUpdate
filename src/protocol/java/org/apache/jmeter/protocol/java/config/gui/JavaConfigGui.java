...
//            
//            if(currArgsMap.keySet().size()==0){
//            	System.out.println("currArgsMap.keySet().size()_1:"+currArgsMap.keySet().size());
//            	if (testParams != null) {
...
//                }
//            }else{
//            	System.out.println("currArgsMap.keySet().size()_2:"+currArgsMap.keySet().size());
//                //循环jmx文件中保存的key value值
//                for (Map.Entry<String, String> keyValue : currArgsMap.entrySet()) {       
//                	String realName = keyValue.getKey();
//                	String realValue = keyValue.getValue();
//                	newArgs.addArgument(realName, realValue);
//                	System.out.println("realName:"+realName +"-- realValue:"+realValue);
//                	
//                }  
//                
//            }
...
//	      	String realValue = keyValue.getValue();
//	      	if(testParams != null){
//	      		defaultParams = testParams.getArgumentsAsMap();
//	      		for (Map.Entry<String, String> keyValueInner : defaultParams.entrySet()) {       
//	      			String defaultName = keyValueInner.getKey();
//	      			String defaultValue = keyValueInner.getValue();
//	      			if(!realName.equals(defaultName)){
//	      				newArgs.addArgument(realName, realValue);
//	      			}
//	      		}
//	      	}
